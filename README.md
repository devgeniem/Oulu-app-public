...
**Android**
1. Run oulu.sh to set system variables for the signing config. Make sure you run it in the same shell with `. oulu.sh`
2. `npm run android:build` or in case this doesnt work, go to android\ and run `gradlew assembleRelease`
