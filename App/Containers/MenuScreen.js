...
class MenuScreen extends React.Component {
  ...
  renderLinksIcon = () => <SimpleIcon size={18} color={Colors.white} name={'link'} />
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          ...
          <NavButton text={I18n.t('links').toLowerCase()} renderIcon={this.renderLinksIcon} onPress={this.links} />
        </View>
      </View>
    )
  }
